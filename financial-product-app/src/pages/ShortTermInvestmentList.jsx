...
const BASE_PRICE = getBasePrice('Short-Term Investment Product');

const INVESTMENTS = [
  { id: 'fixed-deposit-32', name: '32-Day Fixed Deposit', addOn: 0 },
  { id: 'money-market', name: 'Money Market Account', addOn: 300 },
  { id: 'notice-deposit-91', name: '91-Day Notice Deposit', addOn: 150 },
  { id: 'flexible-savings', name: 'Flexible Savings Account', addOn: 0 },
].map((item) => ({ ...item, price: BASE_PRICE + item.addOn }));

export default function ShortTermInvestmentList() {
    ...
    <div className="investment-list">
      ...
      <div className="investment-list__inner">
        <div className="page-header">
          ...
          <h1 className="investment-list__title">Short-Term Investments</h1>
        </div>

        <SearchBar
          value={search}
          onChange={setSearch}
          placeholder="Search short-term investments"
        />
